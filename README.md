...
Here is what I have been working on (my board shows more detail)

1. LearnJavaSciptOnline
1. LearnProgrammingOnline
...
1. Create the standard format for HTML
1. Write Inline CSS
1. Link an External CSS file
1. Create a webpage
1. Customize a webpage
